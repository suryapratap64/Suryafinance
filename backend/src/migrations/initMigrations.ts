...
// // initMigrations.ts uses a direct Postgres connection (pg Pool) which is the correct approach for bootstrapping database plumbing (create migrations table and create exec_sql) because it doesn’t depend on exec_sql already existing.
